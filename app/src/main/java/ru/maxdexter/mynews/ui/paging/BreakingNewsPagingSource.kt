...
class BreakingNewsPagingSource(private val api:NewsAPI,private val category: String): PagingSource<Int,Article>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article> {
        ...
        return try {
            val response = api.getBreakingNews(pageNumber = position,category = category,pageSize = params.loadSize)
